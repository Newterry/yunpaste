...
const zhCN = {
  ...
  "auth.hero": "把灵感与文件，安全地放在一起。", "auth.subtitle": "文本、图片、音视频与文档，在你的私有空间自然流转。",
  "auth.preview": "多格式即时预览", "auth.private": "私有部署与权限控制", "auth.responsive": "桌面与移动端自然适配",
...
const dictionaries: Record<AppLocale, Messages> = {
  ...
  "en-US": {
    ...
    "auth.hero": "Keep ideas and files together, securely.", "auth.subtitle": "Text, images, media and documents flow naturally through your private space.", "auth.preview": "Instant multi-format preview", "auth.private": "Private hosting and access control", "auth.responsive": "Designed for desktop and mobile", "auth.login": "Sign in", "auth.register": "Register", "auth.welcome": "Welcome back", "auth.loginHint": "Sign in with your username or email", "auth.account": "Username or email", "auth.password": "Password", "auth.submit": "Open YunPaste", "auth.busy": "Signing in…"
  },
  "ja-JP": {
