...
const zhCN = {
  ...
  "mobile.pull": "下拉刷新", "mobile.release": "松开即可刷新", "mobile.refreshing": "正在刷新…",
...
const dictionaries: Record<AppLocale, Messages> = {
  ...
  "zh-TW": {
    ...
    "mobile.pull": "下拉重新整理", "mobile.release": "放開即可重新整理", "mobile.refreshing": "正在重新整理…",
  ...
  "en-US": {
    ...
    "mobile.pull": "Pull to refresh", "mobile.release": "Release to refresh", "mobile.refreshing": "Refreshing…",
  ...
  "ja-JP": {
    ...
    "mobile.pull": "下に引いて更新", "mobile.release": "離して更新", "mobile.refreshing": "更新中…"
  },
  "ko-KR": {
    ...
    "mobile.pull": "아래로 당겨 새로고침", "mobile.release": "놓아서 새로고침", "mobile.refreshing": "새로고침 중…"
  },
  "es-ES": {
    ...
    "mobile.pull": "Desliza para actualizar", "mobile.release": "Suelta para actualizar", "mobile.refreshing": "Actualizando…"
  },
  "fr-FR": {
    ...
    "mobile.pull": "Tirez pour actualiser", "mobile.release": "Relâchez pour actualiser", "mobile.refreshing": "Actualisation…"
  }
};
